    ...
    <div class="app">
        <div class="form" >
            ...
            <div class="form__group" :class="{invalid: $v.rate.$error, valid: !$v.rate.$invalid}">
                ...
                <div v-if="$v.rate.$error" class="error">
                    ...
                    <span class="helper-text" v-else-if="!$v.rate.between">
                        Ставка должна быть больше 1 и меньше 100
                    </span>
				</div>
            </div>
            <div class="loan-time">
            ...
            <div class="type_credit">
                    <input type="radio" id="type_anuent" name="radio_type" value="anuent" checked v-model="type_credit">
                    <label for="type_anuent">Аннуитетный</label>
                    <input type="radio" id="type_dif" name="radio_type" value="dif" v-model="type_credit">
                    <label for="type_dif">Дифференцированный</label>
            </div>
